export const features = [
  {
    ...
    title: "Agile Expertise & Rapid Response",
    description:
      "We use agile methods, rapid responses, and proactive communication to adapt quickly, work efficiently, and deliver on time",
    delay: "0",
  },
  {
    icon: "bi-buildings-fill",
    title: "World-Class Technical Proficiency",
    description:
      "Our expert team combines deep technical mastery with innovation to tackle complex challenges and deliver robust, future-proof digital products.",
    delay: "100",
  },
  {
    icon: "bi-speedometer",
    title: "Strategic Partnership with Speed & Professionalism",
    description:
      "We match your business pace with top-tier professionalism, serving as your dedicated, efficient, and reliable partner from concept to deployment and beyond.",
    delay: "200",
  },
  {
    icon: "bi-sliders",
    title: "Tailored Solutions for Tangible Impact",
    description:
      "We craft bespoke software tailored to your workflows and goals, delivering measurable improvements and a clear competitive edge.",
    delay: "300",
  },
];
...
export const steps = [
  {
    number: 1,
    title: "Strategize & Define",
    description:
      "We start with an in-depth consultation to understand your business and goals. Our experts then craft a detailed roadmap, defining project scope, technology stack, and a strategic plan to build a solution that meets your needs.",
    delay: "0",
    archLine: "normal" as const,
    archDelay: "500",
  },
  {
    number: 2,
    title: "Innovate & Develop",
    description:
      "Leveraging our agile approach, we begin development with a focus on speed and quality. We work collaboratively, providing regular updates and incorporating your feedback to ensure the final product is perfectly aligned with your vision.",
    delay: "600",
    archLine: "reverse" as const,
    archDelay: "1100",
  },
  {
    number: 3,
    title: "Test & Deliver",
    description:
      "Before launch, every solution undergoes rigorous quality assurance and testing to ensure it\u2019s robust, secure, and performs flawlessly. We handle the seamless deployment of your solution, getting it into your hands swiftly.",
    delay: "1200",
    archLine: "normal" as const,
    archDelay: "1700",
  },
  {
    ...
    description:
      "Our commitment extends beyond the launch. We provide ongoing support and maintenance to ensure your software remains relevant and performs optimally, helping your business adapt and grow.",
    delay: "1800",
    archLine: null,
    archDelay: null,
  },
