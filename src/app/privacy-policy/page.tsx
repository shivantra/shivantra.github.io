        ...
        <main id="main-content">
          <section className="terms section">
            <div className="container" data-aos="fade-up" data-aos-delay="200">
              ...
              <h5 className="mt-5 fw-semibold">Information Collection and Use</h5>
              <p className="justify-content">
                We collect various types of information for different purposes to provide and
                improve our services to you.
              </p>

              <h6 className="fw-semibold">Cookie &amp; Usage Data</h6>
              <p className="justify-content">
              ...
              <h6 className="fw-semibold">Tracking &amp; Cookies Data</h6>
              <p className="justify-content">
              ...
              <h6 className="fw-semibold">Types of Cookies:</h6>
              ...
              <h5 className="mt-5 fw-semibold">Use of Data</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Transfer of Data</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Disclosure of Data</h5>
              <h6 className="fw-semibold">Legal Requirements</h6>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Security of Data</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Analytics</h5>
              <p className="justify-content">
                We may use third-party Service Providers to monitor and analyze the use of our
                Services.
              </p>

              <h5 className="mt-5 fw-semibold">Links to Other Sites</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Children&apos;s Policy</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Changes to This Privacy Policy</h5>
              <p className="justify-content">
