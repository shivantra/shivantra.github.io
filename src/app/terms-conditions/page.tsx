        ...
        <main id="main-content">
          <section className="terms section">
            <div className="container" data-aos="fade-up" data-aos-delay="200">
              ...
              <h5 className="mt-5 fw-semibold">Overview</h5>
              ...
              <h5 className="mt-5 fw-semibold">Section 1 - Online Services Terms</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 2 - General Conditions</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 3 - User Personal Information</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 5 - Modifications to Services and Prices</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 6 - Warranties and Disclaimers</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 7 - Services Offered</h5>
              <p className="justify-content">Our services include, but are not limited to:</p>
              ...
              <h5 className="mt-5 fw-semibold">Section 8 - Billing and Account Information</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 9 - Third-Party Tools and Links</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 10 - User Comments and Feedback</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 11 - Errors and Omissions</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 12 - Prohibited Uses</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 13 - Indemnification</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 14 - Severability</h5>
              <p className="justify-content">
                If any provision of these Terms is deemed unlawful or unenforceable, the remaining
                provisions shall remain in effect.
              </p>

              <h5 className="mt-5 fw-semibold">Section 15 - Termination</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 16 - Entire Agreement</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 17 - Governing Law</h5>
              <p className="justify-content">
                These Terms are governed by the laws of India. Any disputes shall be resolved in
                the courts of Bharuch, Gujarat, India.
              </p>

              <h5 className="mt-5 fw-semibold">Section 18 - Changes to Terms of Service</h5>
              <p className="justify-content">
              ...
              <h5 className="mt-5 fw-semibold">Section 19 - Contact Information</h5>
              <p className="justify-content">
                Questions about these Terms should be directed to us at{" "}
                <a href="mailto:contact@shivantra.com">contact@shivantra.com</a>.
              </p>

              <h5 className="mt-5 fw-semibold">Section 20 - Company Information</h5>
              <p className="justify-content">
