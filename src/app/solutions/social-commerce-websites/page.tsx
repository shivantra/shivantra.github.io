...
const pageUrl = `${siteUrl}/solutions/social-commerce-websites`;

export const metadata: Metadata = {
  title: "Social Commerce & Creator-Led Brand Websites | Shivantra",
  description:
    "Websites for creator-led and social-commerce brands connecting social discovery, product content, campaigns, ecommerce and first-party customer journeys.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Social Commerce & Creator-Led Brand Websites | Shivantra",
    description: "Websites for creator-led and social-commerce brands connecting social discovery, product content, campaigns, ecommerce and first-party customer journeys.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Social Commerce & Creator-Led Brand Websites", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Social Commerce & Creator-Led Brand Websites",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/social-commerce-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Audience lives on external platforms",
  "Campaign links scatter across destinations",
  "Product details are inconsistent",
  "Brand depends too heavily on one social channel",
  "Limited first-party measurement",
  "Creator content and ecommerce are disconnected",
];
...
const capabilities = [
  ...
  "UGC/reviews where authorized",
  "Ecommerce",
  "Email capture",
  "Analytics",
  "UTM/source tracking",
  "Creator campaign pages",
  "Mobile-first design",
];
...
const faqs = [
  {
    id: "social-why-website",
    question: "Why have a website if we sell through social platforms?",
    answer: "An owned website gives the brand control over content, customer journeys, first-party data and cross-channel continuity while social platforms continue to drive discovery.",
    open: true,
  },
  {
    id: "social-creator-content",
    question: "Can creator content be embedded?",
    answer: "Yes, subject to platform rules and content rights. Heavy embeds should be managed carefully for performance.",
    open: false,
  },
  {
    id: "social-dedicated-pages",
    question: "Can campaigns have dedicated pages?",
    answer: "Yes. Creator or platform-specific landing pages can preserve the message and source context.",
    open: false,
  },
  {
    id: "social-sell-directly",
    question: "Can the website sell products directly?",
    answer: "Yes, through an appropriate ecommerce platform or integration.",
    open: false,
  },
];
...
export default function SocialCommerceWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap social-commerce-websites-page">
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  <Tag hero marginBottom>
                    Social Commerce & Creator-Led Brand Websites
                  </Tag>
                  <PageTitle>Give Social Discovery a Destination You Control</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=social-commerce-websites`} className="btn-primary">
                      Discuss Your Social Commerce Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    ...
                    caption="Social/creator content flowing into owned website, product and customer relationship"
                    cues={["Social Content", "Owned Website", "Product", "Customer Relationship"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="social-commerce-websites-faq-accordion">
                    {faqs.map((faq) => (
