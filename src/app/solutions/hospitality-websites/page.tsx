...
const pageUrl = `${siteUrl}/solutions/hospitality-websites`;

export const metadata: Metadata = {
  title: "Hospitality Websites | Shivantra",
  description:
    "Hospitality website development for hotels, resorts and stays covering rooms, experiences, booking integrations, locations, multilingual content and performance.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Hospitality Websites | Shivantra",
    description: "Hospitality website development for hotels, resorts and stays covering rooms, experiences, booking integrations, locations, multilingual content and performance.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Hospitality Websites", href: null },
];
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/hospitality-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Booking engine feels disconnected",
  "Mobile photo-heavy pages are slow",
  "Room information is inconsistent",
  "Third-party platforms own the customer journey",
  "Multiple properties are hard to manage",
  "International guests need localization",
];
...
const faqs = [
  {
    ...
    question: "Can you integrate an existing booking engine?",
    answer: "Yes, depending on the booking platform's supported integration options.",
    open: true,
  },
  {
    id: "hospitality-multi-property",
    question: "Can one CMS manage multiple properties?",
    answer: "Yes. A structured content model can support shared and property-specific content.",
    open: false,
  },
  {
    id: "hospitality-multilingual",
    question: "Can the site be multilingual?",
    answer: "Yes. Localization should be planned into CMS and URL architecture.",
    open: false,
  },
  {
    id: "hospitality-galleries",
    question: "How do you handle large image galleries without slowing the site?",
    answer: "Through responsive image delivery, sensible formats, lazy loading and careful media design.",
    open: false,
  },
];
...
export default function HospitalityWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap hospitality-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Give Guests a Clear Path From Discovery to Booking</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=hospitality-websites`} className="btn-primary">
                      Discuss Your Hospitality Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-building"
                    caption="Travel discovery to property/room to booking engine"
                    cues={["Discovery", "Property / Room", "Booking Engine"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="hospitality-websites-faq-accordion">
                    {faqs.map((faq) => (
