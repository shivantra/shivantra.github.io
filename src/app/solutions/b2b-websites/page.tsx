...
const pageUrl = `${siteUrl}/solutions/b2b-websites`;

export const metadata: Metadata = {
  title: "B2B Websites | Shivantra",
  description:
    "B2B website development for longer buying journeys, technical services, lead generation, case studies, resources, CRM integration and sales enablement.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "B2B Websites | Shivantra",
    description: "B2B website development for longer buying journeys, technical services, lead generation, case studies, resources, CRM integration and sales enablement.",
    url: pageUrl,
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/b2b-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  ...
  "Technical information is scattered",
  "Website generates low-quality leads",
  "Sales lacks useful digital material",
];

const capabilities = [
  "Service/solution architecture",
  "Industry pages where genuinely distinct",
  "Case studies and proof",
  "Technical resources and downloads",
  "Lead qualification",
  "CRM integration",
  "Account-specific or partner content where needed",
  "Analytics tied to lead quality",
];
...
const faqs = [
  {
    id: "b2b-vs-normal",
    question: "How is a B2B website different from a normal business website?",
    answer: "B2B buyers often need more context, proof, technical detail and internal justification before contacting sales. The website should support that longer decision process.",
    open: true,
  },
  {
    id: "b2b-industry-pages",
    question: "Should every industry get its own page?",
    answer: "Only when the use case, terminology, proof or offer genuinely differs. Copying the same page with industry names swapped creates weak content.",
    open: false,
  },
  {
    id: "b2b-qualify-leads",
    question: "Can the website qualify leads before sales?",
    answer: "Yes. Forms can collect structured information and route leads into the CRM based on service, location, account or other business rules.",
    open: false,
  },
  {
    id: "b2b-resources",
    question: "Can we publish technical resources?",
    answer: "Yes. Resource centers can support documents, guides, specifications, case studies and gated or ungated material.",
    open: false,
  },
];
...
export default function B2bWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap b2b-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>B2B Websites That Help Buyers Understand Complex Offers</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=b2b-websites`} className="btn-primary">
                ...
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-diagram-3"
                    caption="A B2B buying journey connecting solution pages, proof, resources and CRM-qualified enquiry"
                    cues={["Solutions", "Proof", "Resources", "CRM"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="b2b-websites-faq-accordion">
                    {faqs.map((faq) => (
