...
const pageUrl = `${siteUrl}/solutions/healthcare-websites`;

export const metadata: Metadata = {
  title: "Healthcare Websites | Shivantra",
  description:
    "Healthcare website development for clinics, hospitals and healthcare professionals focused on clear services, doctors, locations, appointments and accessibility.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Healthcare Websites | Shivantra",
    description: "Healthcare website development for clinics, hospitals and healthcare professionals focused on clear services, doctors, locations, appointments and accessibility.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Healthcare Websites", href: null },
];
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/healthcare-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Patients struggle to find correct service information",
  "Doctor/location information becomes outdated",
  "Appointment paths are confusing",
  "Mobile experience is poor",
  "Health information lacks clear ownership",
  "Accessibility matters for a broad audience",
];
...
const capabilities = [
  ...
  "Doctor profiles",
  "Locations",
  "Appointment/contact flows",
  "Emergency information where applicable",
  "Patient resources",
  "CMS with controlled editing",
  "Accessibility",
  "Local information",
...
const faqs = [
  {
    ...
    question: "Can you build appointment booking?",
    answer: "Yes, either directly or by integrating an existing scheduling platform, depending on the workflow.",
    open: true,
  },
  {
    id: "health-doctor-profiles",
    question: "Can doctors manage their profiles?",
    answer: "The CMS can support controlled profile management, but governance should define who is responsible for accuracy and publication.",
    open: false,
  },
  {
    id: "health-accessibility",
    question: "Do healthcare websites need accessibility?",
    answer: "Accessibility is especially important for broad public-facing health information. Requirements should be defined against the organization's target standard.",
    open: false,
  },
  {
    id: "health-medical-content",
    question: "Can you write medical content?",
    answer: "We can structure and edit supplied content, but clinical accuracy should be reviewed and approved by appropriately qualified healthcare professionals.",
    open: false,
  },
];
...
export default function HealthcareWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap healthcare-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Healthcare Websites Built for Clear Information and Easier Access</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=healthcare-websites`} className="btn-primary">
                ...
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-heart-pulse"
                    caption="Patient journey from service information to doctor/location to appointment"
                    cues={["Services", "Doctors", "Locations", "Appointment"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="healthcare-websites-faq-accordion">
                    {faqs.map((faq) => (
