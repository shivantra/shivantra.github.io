...
const pageUrl = `${siteUrl}/solutions/small-business-websites`;

export const metadata: Metadata = {
  title: "Websites for Small Businesses | Shivantra",
  description:
    "Small business website development focused on credibility, services, local visibility, enquiries, easy content management and room to grow.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Websites for Small Businesses | Shivantra",
    description: "Small business website development focused on credibility, services, local visibility, enquiries, easy content management and room to grow.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Websites for Small Businesses", href: null },
];
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/small-business-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "No official website or an outdated one",
  "Reliance on social media or directory listings",
  "Services are difficult to understand online",
  "Website is hard to update",
  "Enquiries arrive through scattered channels",
  "Limited internal technical resources",
];

const capabilities = [
  "Clear homepage and service structure",
  "About and trust content",
  "Contact and enquiry journeys",
  "CMS for routine updates",
  "Local/contact information",
  "Analytics and conversion tracking",
  "Technical SEO foundations",
  "CRM or WhatsApp integration where useful",
];
...
const faqs = [
  {
    id: "sbw-how-much",
    question: "How much website does a small business actually need?",
    answer: "Enough to explain the business, important services, trust signals and next step. Page count should follow the information customers need rather than a fixed package.",
    open: true,
  },
  {
    id: "sbw-self-update",
    question: "Can we update the site ourselves?",
    answer: "Yes. Where regular changes are expected, the CMS can be structured so routine content edits do not require a developer.",
    open: false,
  },
  {
    id: "sbw-whatsapp-crm",
    question: "Can you connect enquiries to WhatsApp or CRM?",
    answer: "Yes, when that matches the business process and the required platform integration is available.",
    open: false,
  },
  {
    id: "sbw-custom-software",
    question: "Do small businesses need custom software?",
    answer: "Usually not for the first website. We prefer the simplest maintainable architecture that meets the business requirement.",
    open: false,
  },
];
...
export default function SmallBusinessWebsites() {
  return (
    <>
      ...
      />
      <div className="site-wrap small-business-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>A Professional Website Without Unnecessary Complexity</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=small-business-websites`} className="btn-primary">
                      Discuss Your Small Business Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-shop"
                    caption="A clean small-business website with service cards, trust information and a clear enquiry path"
                    cues={["Services", "Trust", "Contact"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="small-business-websites-faq-accordion">
                    {faqs.map((faq) => (
