...
const pageUrl = `${siteUrl}/solutions/local-service-business-websites`;

export const metadata: Metadata = {
  title: "Local Service Business Websites | Shivantra",
  description:
    "Local service business websites for service pages, locations, local search foundations, calls, WhatsApp, bookings, reviews and lead routing.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Local Service Business Websites | Shivantra",
    description: "Local service business websites for service pages, locations, local search foundations, calls, WhatsApp, bookings, reviews and lead routing.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Local Service Business Websites", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Local Service Business Websites",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/local-service-business-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Business relies only on Google/social listings",
  "Service area is unclear",
  "Calls and WhatsApp are not tracked",
  "Location information is inconsistent",
  "Website is slow on mobile",
  "Generic pages do not explain individual services",
];

const capabilities = [
  "Service pages",
  "Service-area/location pages where genuine",
  "Phone/WhatsApp CTA",
  "Booking/enquiry",
  "Reviews where authentic",
  "Maps",
...
const faqs = [
  {
    ...
    answer: "Only where the business genuinely serves that area and the page can provide useful, locally specific information. Mass-producing near-identical city pages is not a good content strategy.",
    open: true,
  },
  {
    id: "local-whatsapp-tracking",
    question: "Can you add WhatsApp and call tracking?",
    answer: "Yes, where appropriate to the business and analytics setup.",
    open: false,
  },
  {
    id: "local-bookings",
    question: "Can you connect bookings?",
    answer: "Yes, using a supported booking platform or custom workflow.",
    open: false,
  },
  {
    id: "local-seo",
    question: "Can you help with local SEO?",
    answer: "We can implement technical and website foundations such as location structure, metadata and structured information; broader local reputation and listing management may be separate.",
    open: false,
  },
];
...
export default function LocalServiceBusinessWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap local-service-business-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Make It Easy for Nearby Customers to Understand, Trust and Contact You</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=local-service-business-websites`} className="btn-primary">
                      Discuss Your Local Business Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-geo-alt"
                    caption="Nearby search to service page to call/message/booking"
                    cues={["Nearby Search", "Service Page", "Call / Message / Booking"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="local-service-business-websites-faq-accordion">
                    {faqs.map((faq) => (
