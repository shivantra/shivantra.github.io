...
const pageUrl = `${siteUrl}/solutions/restaurant-websites`;

export const metadata: Metadata = {
  title: "Restaurant & Food Brand Websites | Shivantra",
  description:
    "Restaurant and food brand website development for menus, locations, reservations, ordering, events, franchises, SEO and social campaigns.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Restaurant & Food Brand Websites | Shivantra",
    description: "Restaurant and food brand website development for menus, locations, reservations, ordering, events, franchises, SEO and social campaigns.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Restaurant & Food Brand Websites", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Restaurant & Food Brand Websites",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/restaurant-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Menu only exists as an awkward PDF",
  "Hours/locations are inconsistent",
  "Social profiles carry more information than the website",
  "Booking/order paths are unclear",
  "Multi-location content is duplicated",
  "Franchise information is scattered",
];
...
const faqs = [
  {
    id: "restaurant-menu-pdf",
    question: "Should the menu be a PDF?",
    answer: "A downloadable PDF can exist, but important menu information is usually easier to use when presented as responsive web content.",
    open: true,
  },
  {
    id: "restaurant-reservations",
    question: "Can you integrate reservations?",
    answer: "Yes, through supported booking systems or APIs.",
    open: false,
  },
  {
    id: "restaurant-multi-location",
    question: "Can one site manage multiple locations?",
    answer: "Yes. Locations can be structured as reusable CMS content with their own hours, contact details and menus where needed.",
    open: false,
  },
  {
    id: "restaurant-online-ordering",
    question: "Can you integrate online ordering?",
    answer: "Yes, when the ordering platform provides a suitable link, embed or API.",
    open: false,
  },
];
...
export default function RestaurantWebsites() {
  return (
    <>
      ...
      />
      <div className="site-wrap restaurant-websites-page">
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  <Tag hero marginBottom>
                    Restaurant & Food Brand Websites
                  </Tag>
                  <PageTitle>Turn Search and Social Discovery Into a Clear Visit or Order Path</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=restaurant-websites`} className="btn-primary">
                      Discuss Your Restaurant Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-cup-hot"
                    caption="Mobile visitor from search/social to menu, location, booking/order"
                    cues={["Search / Social", "Menu", "Location", "Booking / Order"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="restaurant-websites-faq-accordion">
                    {faqs.map((faq) => (
