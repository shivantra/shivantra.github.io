...
const pageUrl = `${siteUrl}/solutions/professional-services-websites`;

export const metadata: Metadata = {
  title: "Websites for Professional Services | Shivantra",
  description:
    "Websites for consultants, professional firms and specialist practices focused on expertise, trust, service clarity, enquiries and thought leadership.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Websites for Professional Services | Shivantra",
    description: "Websites for consultants, professional firms and specialist practices focused on expertise, trust, service clarity, enquiries and thought leadership.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Websites for Professional Services", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Websites for Professional Services",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/professional-services-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Expertise is clear offline but vague online",
  "Services overlap or use internal terminology",
  "Website feels generic",
  "Individual experts are not visible",
  "Referral prospects cannot validate the firm quickly",
  "Thought leadership is difficult to publish",
];

const capabilities = [
  "Service positioning",
  "Expert/team profiles",
  "Sector or client-type content",
  "Case studies where confidentiality allows",
  "Insights/resources",
  "Consultation/enquiry flows",
  "CMS",
  "Appointment or CRM integration",
];
...
const faqs = [
  {
    id: "psw-team-members",
    question: "Should professional firms show team members?",
    answer: "Usually yes when individual expertise is relevant to the buying decision. Profiles should be factual and useful, not padded biographies.",
    open: true,
  },
  {
    id: "psw-confidential-proof",
    question: "How do we show proof if client work is confidential?",
    answer: "Use anonymized case studies, process examples, credentials, sector experience or clearly approved client references.",
    open: false,
  },
  {
    id: "psw-articles",
    question: "Can we publish articles ourselves?",
    answer: "Yes. A CMS can support insights, resources and author profiles.",
    open: false,
  },
  {
    id: "psw-bookings",
    question: "Can the website support consultation bookings?",
    answer: "Yes. It can connect to scheduling or CRM workflows where appropriate.",
    open: false,
  },
];
...
export default function ProfessionalServicesWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap professional-services-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Turn Expertise Into a Website People Can Understand and Trust</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=professional-services-websites`} className="btn-primary">
                      Discuss Your Professional Services Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-briefcase"
                    caption="Expertise flowing into services, people, insights and consultation CTA"
                    cues={["Services", "People", "Insights", "Consultation"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="professional-services-faq-accordion">
                    {faqs.map((faq) => (
