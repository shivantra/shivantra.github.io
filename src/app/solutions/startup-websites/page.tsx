...
const pageUrl = `${siteUrl}/solutions/startup-websites`;

export const metadata: Metadata = {
  title: "Websites for Startups | Shivantra",
  description:
    "Startup website development for product positioning, launch pages, waitlists, demos, investor credibility, content, analytics and rapid iteration.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Websites for Startups | Shivantra",
    description: "Startup website development for product positioning, launch pages, waitlists, demos, investor credibility, content, analytics and rapid iteration.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Websites for Startups", href: null },
];
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/startup-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  ...
  "Need waitlist/demo/signup flows",
  "Limited proof at early stage",
  "Website and product brand need to stay aligned",
];
...
const capabilities = [
  ...
  "Social proof as it becomes available",
  "Investor/company credibility",
  "CMS or composable content",
  "Analytics",
...
const faqs = [
  {
    id: "startup-large-website",
    question: "Do startups need a large website at launch?",
    answer: "Usually not. A focused website that explains the problem, product and next step is often stronger than many thin pages.",
    open: true,
  },
  {
    id: "startup-evolve-positioning",
    question: "Can the website evolve as positioning changes?",
    answer: "Yes. Reusable components and structured content make iteration easier.",
    open: false,
  },
  {
    id: "startup-waitlist-demo",
    question: "Can you build waitlists or demo flows?",
    answer: "Yes. These can connect to CRM, email, analytics or product systems.",
    open: false,
  },
  {
    id: "startup-headless-cms",
    question: "Should a startup use headless CMS?",
    answer: "Only when frontend independence or structured content justifies it. A simpler architecture may be better early on.",
    open: false,
  },
];
...
export default function StartupWebsites() {
  return (
    <>
      ...
      />
      <div className="site-wrap startup-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Explain the New Idea Clearly Before Adding More Pages</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=startup-websites`} className="btn-primary">
                      Discuss Your Startup Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    ...
                    caption="Startup message evolving from problem to product to demo/signup"
                    cues={["Problem", "Product", "Demo", "Signup"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="startup-websites-faq-accordion">
                    {faqs.map((faq) => (
