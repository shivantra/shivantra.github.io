...
const pageUrl = `${siteUrl}/solutions/saas-websites`;

export const metadata: Metadata = {
  title: "SaaS & Software Product Websites | Shivantra",
  description:
    "SaaS website development for product positioning, feature and use-case content, demos, trials, documentation, integrations, analytics and growth.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "SaaS & Software Product Websites | Shivantra",
    description: "SaaS website development for product positioning, feature and use-case content, demos, trials, documentation, integrations, analytics and growth.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "SaaS & Software Product Websites", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "SaaS & Software Product Websites",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/saas-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  ...
  "Buyers cannot understand who the product is for",
  "Too many generic solution pages",
  "Demo/signup journey is disconnected",
  "Documentation and marketing are fragmented",
  "Product evolves faster than the website",
];
...
const capabilities = [
  ...
  "Demo/trial/signup",
  "Documentation/resource connections",
  "Comparison pages only when factual",
  "Analytics",
  "CRM",
  "CMS for fast iteration",
];
...
const faqs = [
  {
    id: "saas-features-usecases",
    question: "Should SaaS sites organize around features or use cases?",
    answer: "Usually both are useful, but use cases help buyers connect product capabilities to their actual problems.",
    open: true,
  },
  {
    id: "saas-signup",
    question: "Can the website connect to product signup?",
    answer: "Yes. Signup, trial and demo flows can connect to authentication, CRM or product systems.",
    open: false,
  },
  {
    id: "saas-integrations-dynamic",
    question: "Can we publish integrations dynamically?",
    answer: "Yes. Structured CMS content or APIs can support an integration directory.",
    open: false,
  },
  {
    id: "saas-headless-cms",
    question: "Do SaaS sites need headless CMS?",
    answer: "Not always. It is useful when content structure, frontend independence or multiple delivery channels justify the architecture.",
    open: false,
  },
];
...
export default function SaasWebsites() {
  return (
    <>
      ...
      />
      <div className="site-wrap saas-websites-page">
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  <Tag hero marginBottom>
                    SaaS & Software Product Websites
                  </Tag>
                  <PageTitle>Explain the Product, Prove the Use Case and Make the Next Step Obvious</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=saas-websites`} className="btn-primary">
                      Discuss Your SaaS Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-cpu"
                    caption="Problem/use case to product capability to demo/trial"
                    cues={["Use Case", "Product Capability", "Demo / Trial"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="saas-websites-faq-accordion">
                    {faqs.map((faq) => (
