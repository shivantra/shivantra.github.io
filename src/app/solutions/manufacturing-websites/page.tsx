...
const pageUrl = `${siteUrl}/solutions/manufacturing-websites`;

export const metadata: Metadata = {
  title: "Manufacturing Websites | Shivantra",
  description:
    "Manufacturing website development for products, capabilities, industries, technical documents, distributors, enquiries and ERP-connected data.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Manufacturing Websites | Shivantra",
    description: "Manufacturing website development for products, capabilities, industries, technical documents, distributors, enquiries and ERP-connected data.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Manufacturing Websites", href: null },
];
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/manufacturing-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  "Large product/capability range",
  "Technical specifications are difficult to navigate",
  "PDFs carry too much information",
  "Buyers need sector-specific context",
  "Distributor/location information is scattered",
  "Product data already exists in ERP or other systems",
];
...
const faqs = [
  {
    id: "mfg-erp-data",
    question: "Can product data come from ERP?",
    answer: "Yes, where the ERP exposes a suitable integration method. Ownership of product data should be defined so teams do not maintain the same fields twice.",
    open: true,
  },
  {
    id: "mfg-filters",
    question: "Can you build filters and product finders?",
    answer: "Yes. Structured product attributes can support search, filtering and guided selection.",
    open: false,
  },
  {
    id: "mfg-pdfs",
    question: "Can technical PDFs remain available?",
    answer: "Yes, though important information should not always be trapped only inside PDFs if buyers need to search or compare it online.",
    open: false,
  },
  {
    id: "mfg-multilingual",
    question: "Can manufacturing websites be multilingual?",
    answer: "Yes. Localization should be planned in the content model and URL structure from the beginning.",
    open: false,
  },
];
...
export default function ManufacturingWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap manufacturing-websites-page">
            ...
            <Container>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <PageTitle>Turn Technical Capability Into a Website Buyers Can Navigate</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=manufacturing-websites`} className="btn-primary">
                      Discuss Your Manufacturing Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-gear"
                    caption="Product catalogue connected to specifications, industries, documents and RFQ"
                    cues={["Products", "Specifications", "Industries", "Documents", "RFQ"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="manufacturing-websites-faq-accordion">
                    {faqs.map((faq) => (
