...
const pageUrl = `${siteUrl}/solutions/education-coaching-websites`;

export const metadata: Metadata = {
  title: "Education & Coaching Websites | Shivantra",
  description:
    "Websites for education, training and coaching businesses covering programs, instructors, admissions, bookings, lead journeys, resources and LMS integrations.",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    title: "Education & Coaching Websites | Shivantra",
    description: "Websites for education, training and coaching businesses covering programs, instructors, admissions, bookings, lead journeys, resources and LMS integrations.",
    url: pageUrl,
...
const breadcrumbTrail = [
  ...
  { label: "Education & Coaching Websites", href: null },
];
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Education & Coaching Websites",
    ...
    },
    {
      ...
      itemListElement: breadcrumbTrail
        ...
        .map((crumb, index) => ({
          ...
          position: index + 1,
          name: crumb.label,
          item: `${siteUrl}${crumb.href ?? "/solutions/education-coaching-websites"}`,
        })),
    },
  ],
};
...
const commonProblems = [
  ...
  "Course information is scattered",
  "Lead forms do not capture program interest",
  "Booking/admissions steps are unclear",
  "Content changes every cohort",
  "LMS/payment systems are disconnected",
];

const capabilities = [
  "Program/course pages",
  "Instructor profiles",
  "Cohort/intake information",
  "Admissions/enquiry flows",
  "Booking/payment integration",
  "LMS links/API",
  "Resources",
  "Testimonials where genuine",
  "FAQ",
...
const faqs = [
  {
    id: "education-lms",
    question: "Can you connect an LMS?",
    answer: "Yes, where the LMS provides an appropriate API, SSO or integration mechanism.",
    open: true,
  },
  {
    id: "education-cohorts-cms",
    question: "Can we manage new cohorts in the CMS?",
    answer: "Yes. Structured program and intake content can make recurring updates easier.",
    open: false,
  },
  {
    id: "education-payments",
    question: "Can the website take payments?",
    answer: "Yes, through suitable payment or commerce integrations.",
    open: false,
  },
  {
    id: "education-lead-routing",
    question: "Can campaign leads be routed by course?",
    answer: "Yes. The selected program can be captured and passed into CRM or automation workflows.",
    open: false,
  },
];
...
export default function EducationCoachingWebsites() {
  return (
    <>
      <script
      ...
      />
      <div className="site-wrap education-coaching-websites-page">
              ...
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  <Tag hero marginBottom>
                    Education & Coaching Websites
                  </Tag>
                  <PageTitle>Help Prospective Learners Understand the Program Before They Enrol</PageTitle>
                  ...
                  <div className="cta d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="300">
                    <Button href={`${basePath}/contact/?solution=education-coaching-websites`} className="btn-primary">
                      Discuss Your Education Website
                    </Button>
                  </div>
                </div>
                <div className="col-lg-6">
                  <PlaceholderVisual
                    icon="bi-mortarboard"
                    caption="Program discovery to curriculum/instructor to enquiry/enrolment"
                    cues={["Program Discovery", "Curriculum / Instructor", "Enquiry / Enrolment"]}
                  />
                </div>
              </div>
            </Container>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="education-coaching-websites-faq-accordion">
                    {faqs.map((faq) => (
