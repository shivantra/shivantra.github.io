...
const redesignTriggers = [
  {
    ...
    description:
      "Services, positioning, team or brand have changed while the website stayed the same.",
  },
  {
    icon: "bi-diagram-3",
    title: "Visitors struggle to find information",
    description:
      "Navigation, page hierarchy or content has accumulated without a clear structure.",
  },
  {
    icon: "bi-phone",
    title: "The mobile experience is weak",
    description:
      "The site technically shrinks to a phone but is difficult to read, navigate or use.",
  },
  {
    icon: "bi-pencil-square",
    title: "Your team cannot manage content efficiently",
    description:
      "Routine updates require developers, workarounds or risky page-builder editing.",
  },
  {
    icon: "bi-speedometer2",
    title: "Performance has deteriorated",
    description:
      "Large media, scripts, plugins and legacy implementation can create increasingly heavy pages.",
  },
  {
    icon: "bi-gear-wide-connected",
    title: "The technology has become a constraint",
    description:
      "The platform or codebase may make ordinary improvements unnecessarily difficult.",
  },
  {
    icon: "bi-signpost-split",
    title: "Lead paths are unclear",
    description:
      "Forms, calls to action or service journeys may not reflect how customers actually buy.",
  },
  {
    icon: "bi-arrow-left-right",
    title: "You need to migrate or replatform",
    description:
      "A new CMS or technical architecture may make sense because of changing editorial or technical requirements.",
  },
];
...
const decisionCards = [
  {
    ...
    title: "Refresh",
    description:
      "Best when the structure and technology are fundamentally sound but the interface or content needs improvement.",
  },
  {
    icon: "bi-tools",
    title: "Rebuild",
    description:
      "Best when the existing implementation has become difficult to maintain or the new structure requires substantial changes.",
  },
  {
    icon: "bi-diagram-2",
    title: "Replatform",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "No. Existing URLs should only change when there is a useful reason. Preserving stable, meaningful URLs can simplify migration.",
    open: false,
  },
  {
    id: "redesign-cms",
    ...
    answer:
      "Yes, if the current CMS is still appropriate. We assess whether the problem is design, structure, implementation or the platform itself.",
    open: false,
  },
  {
    id: "redesign-migrate-cms",
  ...
  },
  {
    ...
    answer:
      "Yes. Post-launch support can include issue resolution, monitoring, content updates, improvements and ongoing maintenance.",
    open: false,
  },
];
...
export default function WebsiteRedesign() {
  return (
    <>
      ...
      />
      <div className="site-wrap redesign-page">
        <Navbar activePage="services" />
        <main id="main-content">
          <Section className="redesign-hero first-section">
            <Container>
              <BreadcrumbNav />
              <div className="row align-items-center">
                <div className="col-lg-6 mb-5 mb-lg-0">
                  ...
                  <Description hero aos="fade-up" delay={200}>
                    A website can become outdated long before the business behind it does.
                    Shivantra redesigns websites across structure, content experience, design, CMS,
          ...
          <Section id="why-redesign">
            <Container>
              <SectionHeader tag="A new look is not enough" colClass="col-lg-9">
                <Description aos="fade-up" delay={100}>
                  Businesses usually start thinking about a redesign because something has changed.
                  The company may have grown. The services may be different. The brand may have
                  evolved. The website may be difficult to update, slow on mobile or increasingly
                  dependent on old technology. Customers may struggle to understand what the
                  company actually offers.
                </Description>
                <Description aos="fade-up" delay={200} className="mb-0">
                  A redesign should identify those problems first. Otherwise, it is easy to produce
                  a newer-looking website that carries the same structural problems into a new
                  interface.
                </Description>
              </SectionHeader>
            </Container>
          ...
          <Section className="section-muted" id="redesign-triggers">
            <Container>
              <SectionHeader tag="Common reasons to redesign" title="When a redesign makes sense" />
              <div className="row g-4">
                {redesignTriggers.map((trigger, index) => (
                  <InfoCard key={trigger.title} {...trigger} delay={String(index * 100)} />
                ))}
              </div>
            </Container>
          </Section>
          ...
          <Section id="two-projects">
            <Container>
              <SectionHeader tag="Two projects" title="A responsible redesign is really two projects" colClass="col-lg-9" />
              <div className="row align-items-center g-4 mb-5">
                <div className="col-lg-7">
                  <Description aos="fade-up" delay={100}>
                    The visible project is the new website. The less visible project is protecting
                    and migrating the value the existing website has already accumulated.
                  </Description>
                  <Description aos="fade-up" delay={150} className="fw-semibold">
                    That may include:
                  </Description>
                  <ChecklistList items={migrationAssets} />
                  <Description aos="fade-up" delay={200} className="mt-4 mb-0">
                ...
                <div className="col-lg-5">
                  <div className="row g-3">
                    <div className="col-12">
                      <div className="track-card" data-aos="fade-up" data-aos-delay="100">
                        <span className="track-label">Track A &middot; Experience</span>
                        <ChecklistList items={["Structure", "UX", "Design", "CMS", "Performance"]} />
                      </div>
                    </div>
                    <div className="col-12">
                      <div className="track-card" data-aos="fade-up" data-aos-delay="200">
                        <span className="track-label">Track B &middot; Migration</span>
                        <ChecklistList items={["Content", "URLs", "Redirects", "Metadata", "Analytics"]} />
                      </div>
                    </div>
                    <div className="col-12 text-center">
                      <Description className="mb-0 fw-semibold" aos="fade-up" delay={300}>
                        Both tracks converge into Launch.
                      </Description>
                    </div>
                  </div>
                </div>
          ...
          <Section className="section-muted" id="audit">
            <Container>
              <SectionHeader tag="Before we redesign" title="We first understand what already exists" colClass="col-lg-9">
                <Description aos="fade-up" delay={100}>
              ...
              <div className="row g-4 mb-4">
                {auditAreas.map((area, index) => (
                  <InfoCard key={area.title} {...area} delay={String(index * 100)} />
                ))}
              </div>
          ...
          <Section className="section-muted" id="migration">
            <Container>
              <div className="row g-5 align-items-start">
                ...
                <div className="col-lg-6">
                  <ChecklistList items={migrationChecklist} />
            ...
            <Container>
              <div className="row g-5 align-items-start">
                <div className="col-lg-6">
                  ...
                  />
                  <Description aos="fade-up" delay={100}>
                    Search engines need time to recrawl and process significant site changes. Even
                    a well-managed migration can experience temporary movement while new URLs and
                    signals are processed.
                  </Description>
                </div>
                <div className="col-lg-6">
                  <Description aos="fade-up" delay={100} className="fw-semibold">
                    Our role is to reduce avoidable risk through:
                  </Description>
                  <ChecklistList items={searchRiskChecklist} />
          ...
          <Section className="section-muted" id="decision">
            <Container>
              <SectionHeader tag="Refresh, rebuild or replatform?" title="Not every website needs the same level of change" />
              <div className="row g-4 mb-5">
                {decisionCards.map((card, index) => (
                  <div className="col-md-4" key={card.title} data-aos="fade-up" data-aos-delay={String(index * 100)}>
                    <div className="decision-card">
                      <span className="icon-badge">
                        <i className={`bi ${card.icon}`} aria-hidden="true"></i>
                      </span>
                      <CardTitle className="fs-5 mb-2">{card.title}</CardTitle>
                      <Description className="mb-0">{card.description}</Description>
                    </div>
                  </div>
                ))}
              </div>
              <div className="row">
                <div className="col-lg-9">
                  ...
                  <ChecklistList items={decisionFactors} />
                  <Description className="mt-4 mb-0" aos="fade-up" delay={150}>
            ...
            <Container>
              ...
              <div className="row">
                <div className="col-md-8 mx-auto" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion custom-accordion" id="redesign-faq-accordion">
                    {faqs.map((faq) => (
